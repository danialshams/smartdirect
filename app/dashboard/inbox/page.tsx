    ...
    <DashboardRoute>
      <div className="space-y-5">
        <header className="border-b border-slate-200 pb-5">
          ...
          <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-950">پیام‌ها</h1>
          <p className="mt-2 text-sm text-slate-500">مدیریت گفتگوهای Instagram در یک محیط ساده.</p>
        </header>
