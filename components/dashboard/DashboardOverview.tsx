        ...
        <div className="space-y-6">
            ...
            <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                <StatCard
                    ...
                    description="اکانت فعال اینستاگرام"
                    icon={Camera}
                />
                ...
                <StatCard
                    title="پیام‌ها"
                    value="—"
                    description="زیرساخت پیام‌رسانی"
                    icon={MessageCircle}
                />
                ...
                <StatCard
                    title="وضعیت سرویس"
                    value="فعال"
                    description="سیستم آماده دریافت رویداد"
                    icon={Activity}
                    success
                />
            </section>
            ...
            >
                <div className="mb-4 flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
                    ...
                    <Link
                        href="/api/instagram/connect"
                        className="inline-flex w-fit items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
                    >
                        <Plus size={16} />
                ...
                {instagramAccounts.length === 0 ? (
                    <div className="rounded-[24px] border border-dashed border-slate-300 bg-white px-6 py-14 text-center">
                        ...
                        <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-400">
                            برای شروع، اکانت Professional اینستاگرام
                            خود را به SmartDirect متصل کنید.
                        </p>
            ...
            <section
                id="messages"
                className="scroll-mt-24 rounded-[24px] border border-slate-200 bg-white p-6 sm:p-8"
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-400">
                            مدیریت گفتگوها در مرحله بعدی اضافه می‌شود.
                        </p>
                    </div>
                </div>
            </section>
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-400">
                            سیستم اشتراک ماهانه در مراحل بعدی فعال می‌شود.
                        </p>
                    </div>
                </div>
            </section>
...
function StatCard({
    ...
    return (<div className="rounded-[22px] border border-slate-200 bg-white p-5"> <div className="flex items-start justify-between"> <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-600"> <Icon size={19} strokeWidth={1.8} /> </div>
...
function InstagramAccountCard({
    ...
    return (<div className="rounded-[22px] border border-slate-200 bg-white p-5 transition hover:border-slate-300"> <div className="flex items-start justify-between gap-4"> <div className="flex min-w-0 items-center gap-3"> <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-slate-950 text-xs font-bold text-white">
        IG </div>
