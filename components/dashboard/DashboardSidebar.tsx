...
const menuItems = [
    ...
    { title: "کامنت‌های پاسخ داده نشده", href: "/dashboard/comments", icon: MessageCircleReply },
    ...
    { title: "پیام‌ها", href: "/dashboard#messages", icon: MessageCircle },
    { title: "اینستاگرام", href: "/dashboard#instagram", icon: Camera },
                ...
                <div className="flex h-full flex-col">
                    <div className="flex items-center justify-between border-b border-slate-100 px-6 py-6">
                        <Link href="/dashboard" onClick={onClose} className="flex items-center gap-3">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-950 text-sm font-bold text-white">SD</div>
                            <div>
                                <div className="text-[15px] font-bold tracking-tight">SmartDirect</div>
                                <div className="mt-0.5 text-[10px] text-slate-400">Instagram Automation</div>
                            </div>
                        </Link>
                        <button type="button" onClick={onClose} className="rounded-lg p-2 text-slate-400 transition hover:bg-slate-50 hover:text-slate-700 lg:hidden" aria-label="بستن">
                            <X size={19} strokeWidth={1.8} />
                        </button>
                    </div>

                    <div className="px-4 py-6">
                        <p className="mb-3 px-3 text-[10px] font-semibold tracking-[0.16em] text-slate-400">مدیریت</p>
